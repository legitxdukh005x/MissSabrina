    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("Hey! My Master Joined The Group..Yay! Feeling Great 🥰 . I'd Never Be Against Him. Now All Of You Behave Yourself Good Now 😌 .")
                continue
            ...
            # Give start information when add bot to group
                ...
                update.effective_message.reply_text("Thanks For Adding Me Into Your Groups. If Any Help.. Please PM Me! Make Sure That I'm Admin And I Have All Rights To Maintain Your Group Effectively.")
